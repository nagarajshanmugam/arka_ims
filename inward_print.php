					...
					<tr >
							<?php $loop = $_GET['stick_qty'];
								for($i=0;$i<$loop;$i++)
									{?>
									<td class="<?php $k++;?>">
													<div style="font-size:15px;margin-top:10px; margin-left:50px">&ensp;&ensp;<strong>QTY :<span style="font-size:15px;"><?php echo $sku=$_GET['sku'];?></span></strong> &nbsp;&nbsp;<strong>INV.QTY :<span style="font-size:15px;"><?php echo $sku=$_GET['inv_qty'];?></span></strong></div>
