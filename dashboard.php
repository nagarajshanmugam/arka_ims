<?php
   require('includes/common.php');
	include_once $config['SiteClassPath']."class.Staff.php";
   	include_once $config['SiteClassPath']."class.dashboard.php";
	...
	$objdashboard->AjaxGetLevel1();
	$objdashboard->GetInwardEntry();
	$objdashboard->GetOutwardEntry();
	/*$objStockInward->viewLevels($objArray);
    $objStockInward->list_inward_details();	
	$objStockInward->GetCheckingPersonLists($objArray); 
	if(isset($_POST['hdAction']))
		{
			$objStockInward->InsertStockContent($_POST);
		}
	if(isset($_GET['inward_entry_id']))
		{
			$objStockInward->InwardID($objArray);
		}
    if(isset($_GET['inward_entry_id']) && isset($_GET['sl_no']) && isset($_GET['loc']) && isset($_GET['mname']) && isset($_GET['mcode']))
	{
        $objStockInward->Delete($_GET['inward_entry_id'],$_GET['sl_no'],$_GET['loc'],$_GET['mname'],$_GET['mcode']);		
	}
  ...
  $objSmarty->assign('IncludeTpl', 'dashboard.tpl');
...
$objSmarty->assign('IncludeCSS',
				   /* '<link rel="stylesheet" href="'. $config['SiteGlobalPath'] . 'css/bootstrap.min.css" rel="stylesheet">'. "\n" .*/
				    /*'<link rel="stylesheet" href="'. $config['SiteGlobalPath'] . 'font-awesome/css/font-awesome.css" rel="stylesheet">'. "\n" .*/
					/*'<link rel="stylesheet" href="'. $config['SiteGlobalPath'] . 'css/plugins/toastr/toastr.min.css" rel="stylesheet">'. "\n" .*/
				  /*  '<link rel="stylesheet" href="'. $config['SiteGlobalPath'] . 'js/plugins/gritter/jquery.gritter.css" rel="stylesheet">'. "\n" .
				    '<link rel="stylesheet" href="'. $config['SiteGlobalPath'] . 'css/animate.css" rel="stylesheet">'. "\n" .
				    '<link rel="stylesheet" href="'. $config['SiteGlobalPath'] . 'css/style.css" rel="stylesheet">'. "\n" .*/
            ...
            $objSmarty->assign('IncludeJS', 
				   /* '<script src="'. $config['SiteGlobalPath'] . 'js/jquery-2.1.1.js"></script>'. "\n" .
				    '<script src="'. $config['SiteGlobalPath'] . 'js/bootstrap.min.js"></script>'. "\n" .
				    '<script src="'. $config['SiteGlobalPath'] . 'js/plugins/metisMenu/jquery.metisMenu.js"></script>'. "\n" .
				    '<script src="'. $config['SiteGlobalPath'] . 'js/plugins/slimscroll/jquery.slimscroll.min.js"></script>'. "\n" .*/
				    '<script src="'. $config['SiteGlobalPath'] . 'js/plugins/flot/jquery.flot.js"></script>'. "\n" .
				    '<script src="'. $config['SiteGlobalPath'] . 'js/plugins/flot/jquery.flot.tooltip.min.js"></script>'. "\n" .
				    '<script src="'. $config['SiteGlobalPath'] . 'js/plugins/flot/jquery.flot.spline.js"></script>'. "\n" .
				    '<script src="'. $config['SiteGlobalPath'] . 'js/plugins/flot/jquery.flot.resize.js"></script>'. "\n" .
				    '<script src="'. $config['SiteGlobalPath'] . 'js/plugins/flot/jquery.flot.pie.js"></script>'. "\n" .
				    '<script src="'. $config['SiteGlobalPath'] . 'js/plugins/peity/jquery.peity.min.js"></script>'. "\n" .
				    '<script src="'. $config['SiteGlobalPath'] . 'js/demo/peity-demo.js"></script>'. "\n" .
				   /* '<script src="'. $config['SiteGlobalPath'] . 'js/inspinia.js"></script>'. "\n" .*/
				   /* '<script src="'. $config['SiteGlobalPath'] . 'js/plugins/pace/pace.min.js"></script>'. "\n" .*/
				  /*  '<script src="'. $config['SiteGlobalPath'] . 'js/plugins/jquery-ui/jquery-ui.min.js"></script>'. "\n" .
				    '<script src="'. $config['SiteGlobalPath'] . 'js/plugins/gritter/jquery.gritter.min.js"></script>'. "\n" .*/
				   /* '<script src="'. $config['SiteGlobalPath'] . 'js/plugins/sparkline/jquery.sparkline.min.js"></script>'. "\n" .
				    '<script src="'. $config['SiteGlobalPath'] . 'js/demo/sparkline-demo.js"></script>'. "\n" .*/
				   /* '<script src="'. $config['SiteGlobalPath'] . 'js/plugins/chartJs/Chart.min.js"></script>'. "\n" .
				    '<script src="'. $config['SiteGlobalPath'] . 'js/plugins/toastr/toastr.min.js"></script>'. "\n" .*/
