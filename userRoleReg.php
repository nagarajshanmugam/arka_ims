<?php
   require('includes/common.php');
	...
	//$ObjUserRole->GetPhoneView($objArray);
	//$ObjCustomerReg->GetCustomerLists($objArray);
	
	
	if(isset($_GET['server_response']))
    {
    $objSmarty->assign('SuccessMessage', 'New User Role and Entitled Added Successfully');
    ...
    $objSmarty->assign('IncludeTpl', 'userRoleReg.tpl');
