<?php
   require('includes/common.php');
	...
	if(isset($_GET['server_response']))
         {
          $objSmarty->assign('SuccessMessage1', 'XLS Uploaded Successfully');
         } 
	
		if(isset($_POST['so_acc']))
		{
			$objSalesOrder->UploadSOContent($_POST);
		}
  
  $objSmarty->assign('IncludeTpl', 'SoUp.tpl');
