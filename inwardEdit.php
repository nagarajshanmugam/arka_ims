<?php
   require('includes/common.php');
	...
	$ObjInward->viewLevels($objArray);
	$ObjInward->GetCheckingPersonLists($objArray); 
  if(isset($_GET['inward_entry_id']) && isset($_GET['sl_no']) && isset($_GET['loc']) && isset($_GET['mname']) && isset($_GET['mcode']))
	{
        $ObjInward->DeleteID($_GET['inward_entry_id'],$_GET['sl_no'],$_GET['loc'],$_GET['mname'],$_GET['mcode']);		
	}
	
	if(isset($_GET['server_success1']))
         {
          $objSmarty->assign('SuccessMessage', 'Inward Deleted Successfully');
         } 
