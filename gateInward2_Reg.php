<?php
   require('includes/common.php');
	...
	{
		$objStockInward->UpdateGInwardContent($_POST);
	}
    ...
    {
        $objSmarty->assign('SuccessMessage1', 'New inward and Entitled Updated Successfully');
    } 
	$objStockInward->GetCheckingPersonLists($objArray);  
	
	if(isset($_POST['hdAction'])) {
	$objStockInward->GetInwardMat2($objArray);                  
    }
	if(isset($_GET['po_no']) || isset($_GET['invoice_no']))
		{
	$objStockInward->AjaxGetPoDetails($objArray);                  
		}
	

  $objSmarty->assign('IncludeTpl', 'gateInward2_Reg.tpl');
