...
if($_GET['level']=="L1" || $_GET['level']=="L2" || $_GET['level']=="L3" || $_GET['level']=="E1" || $_GET['level']=="E2" || $_GET['level']=="H1" || $_GET['level']=="H2" )
	{
		...
		for($i=1;$i<=26;$i++)
			...
			for($k=1;$k<=14;$k++)
				...
				$shelves5 = "E".$k;
						...
						$sql = 'INSERT INTO `arka_rack_details_new`
						...
						$sql2 = 'INSERT INTO `arka_rack_details_new`
						            (`zone`,`storage_area`,`levels`, `rows`,`shelves`,`location`,`length`,`width`,`height`,`volume`,`part_volume`,`weight`,`utilization`,`status`) 
						...
						$sql3 = 'INSERT INTO `arka_rack_details_new`
						            (`zone`,`storage_area`,`levels`, `rows`,`shelves`,`location`,`length`,`width`,`height`,`volume`,`part_volume`,`weight`,`utilization`,`status`) 
						...
						$sql4 = 'INSERT INTO `arka_rack_details_new`
						            (`zone`,`storage_area`,`levels`, `rows`,`shelves`,`location`,`length`,`width`,`height`,`volume`,`part_volume`,`weight`,`utilization`,`status`) 
						...
						$sql5 = 'INSERT INTO `arka_rack_details_new`
						            (`zone`,`storage_area`,`levels`, `rows`,`shelves`,`location`,`length`,`width`,`height`,`volume`,`part_volume`,`weight`,`utilization`,`status`) 
