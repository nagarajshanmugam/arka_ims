...
//    $ObjproductDetails->RoleList();
   // $ObjproductDetails->GetMaterialDetails($objArray);
	$ObjproductDetails->GetProductDetails($objArray);

 // if(isset($_POST['hdAction']))
  	//	$ObjproductDetails->EditMaterial($_POST);
  ...
  $objSmarty->assign('IncludeTpl', 'productDetails.tpl');
