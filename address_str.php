<?php
	...
	include_once $config['SiteClassPath']."class.Staff.php";
 	include_once $config['SiteClassPath']."class.Sticker_Print.php";
...
//echo $_GET['sticker_id'];
    $objSticker_Print	= new Sticker_Print();
	if(isset($_GET['sticker_id']))
	{
		$objSticker_Print->Print_Sticker($_GET);
	}
  if(isset($_GET['customer_id']))
	{
		$objSticker_Print->Address_Sticker($_GET);
	}
  $objSmarty->assign('IncludeTpl', 'address_str.tpl');
