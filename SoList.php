<?php
  ...
  include_once $config['SiteClassPath']."class.split_page_results.php"; 
	...
	$objSalesOrder->GetSoList($objArray);
	
	if(isset($_GET['slo']) && isset($_GET['sNo']))
	  {
		$objSalesOrder->DeleteID($_GET);		
      }
	if(isset($_GET['server_responses']))
	 ...
	 {    
  		$objSalesOrder->AddPickList($_POST);
     }	
  $objSmarty->assign('IncludeTpl', 'SoList.tpl');
