<?php
 ...
 // include_once $config['SiteClassPath']."class.split_page_results.php"; 
	...
	$objproductDetails->GetProductEdit();
	
	if(isset($_GET['server_response']))
         {
          $objSmarty->assign('SuccessMessage1', ' Product updated Successfully');
         }
		 if(isset($_POST['hdAction']))
	{    
  		$objproductDetails->EditProduct($_POST);
     }
  ...
  $objSmarty->assign('IncludeTpl', 'productDetailsEdit.tpl');
