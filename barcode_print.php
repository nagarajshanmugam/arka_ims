							...
							<?php $loop = $_GET['stick_qty'];
								for($i=0;$i<$loop;$i++)
									...
									<td class="<?php $k++;?>">
													...
													<div style="font-size:18px;margin-top:-5px; margin-left:15px">&ensp;&ensp;<strong>PKD ON :<span style="font-size:30px;"><?php $date=$_GET['date']; $str = substr($date, 0, 7); echo $str;?></span></strong> </div>
													<svg id="barcode1" /></svg>
													<script> 
