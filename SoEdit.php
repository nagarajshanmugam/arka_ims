<?php
 ...
 // include_once $config['SiteClassPath']."class.split_page_results.php"; 
	...
	$objSalesOrder->GetPickEdit();
	$objSalesOrder->GetPickEdit2();
	
    if(isset($_GET['server_response']))
	 {
	  $objSmarty->assign('SuccessMessage1', 'SO updated Successfully');
	 }
    if(isset($_POST['hdAction']))
	 {    
  		$objSalesOrder->EditSO($_POST);
     }
	 if(isset($_GET['slo']) && isset($_GET['soN']))
     { 
		$objSalesOrder->DeleteEditDetail($_GET);	
     }
  ...
  $objSmarty->assign('IncludeTpl', 'SoEdit.tpl');
