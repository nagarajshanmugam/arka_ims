<?php
   require('includes/common.php');
    ...
    {
        $objSmarty->assign('SuccessMessage1', 'New Sticker Added Successfully');
    } 
		if(isset($_GET['Delete']))
    {
        $objSmarty->assign('SuccessMessage1', 'Sticker Deleted Successfully');
    } 
	if(isset($_GET['sticker_id']))
    {
	$objStickerMgmt->list_Sticker_details($_GET);
	}
		if(isset($_GET['stick_id']))
    {
	$objStickerMgmt->DeleteID($id);
	}
  $objSmarty->assign('IncludeTpl', 'pack_sticker.tpl');
