<?php
   require('includes/common.php');
	...
	//$objstock_mngmnt->RolesLists();


	if(isset($_GET['server_response']))
         {
          $objSmarty->assign('SuccessMessage1', 'New stock Added Successfully');
		 // header('Location:' ."customerDetails.tpl cust_id=".$_GET['cust_id']);
         } 
	
	if(isset($_POST['hdAction']))
	{
  		$objstock_mngmnt->InsertStockContent($_POST);
	}
  
  $objSmarty->assign('IncludeTpl', 'stockReg.tpl');
