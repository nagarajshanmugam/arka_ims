<?php
	...
	if(isset($_GET['inward_entry_id']) && isset($_GET['ora_id']) && isset($_GET['po']) && isset($_GET['inv']))
    $objInward->DeleteID2($deleid);
if(isset($_GET['server_success1']))
         { 
          $objSmarty->assign('SuccessMessage1', 'Inward Deleted Successfully');
         } 
   $objInward->GetInwardList($objArray);
    if(isset($_POST['hdAction']))
	 {    
  		$objInward->AddPutList($_POST);
     }	
  ...
  $objSmarty->assign('IncludeTpl', 'inwardList.tpl');
