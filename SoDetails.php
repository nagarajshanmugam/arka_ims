<?php
  require('includes/common.php');
	...
	if(isset($_GET['oracle_so_no']))
	  {  
		$objSalesOrder->GetSoMasterDetails($_GET['sl_no']);	
		$objSalesOrder->GetSoMasterDetList($_GET['sl_no']);	
		
      }
	if(isset($_GET['slo']) && isset($_GET['soN']))
     { 
		$objSalesOrder->DeleteDetail($_GET);	
     }
  ...
  $objSmarty->assign('IncludeTpl', 'SoDetails.tpl');
