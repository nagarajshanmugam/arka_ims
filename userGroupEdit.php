<?php
   require('includes/common.php');
    ...
    $ObjUserGroup->GetUserGroupDetails();
	if(isset($_GET['server_response']))
         {
          $objSmarty->assign('SuccessMessage', 'User Group Updated Successfully');
		 // header('Location:' ."customerDetails.tpl cust_id=".$_GET['cust_id']);
         } 
	if(isset($_POST['hdAction']))
    	$ObjUserGroup->EditUserGroup($_POST);
		
	
	$groupId = $_GET['group_id'];
	$ObjUserGroup->GetRoles($groupId);
	$ObjUserGroup->GetGroupMap($groupId);
    ...
    $objSmarty->assign('IncludeTpl', 'userGroupEdit.tpl');
