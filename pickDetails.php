<?php
  require('includes/common.php');
	...
	$objStaff->Roleslists();
	  ...
	  {  
		$objpick->GetPickMasterDetails($_GET['sl_no']);	
		$objpick->GetPickMasterDetList($_GET['sl_no']);	
		
       }
	
	//$objpick->GetPickMasterDetails($objArray);
	$objpick->GetPickMasterList($objArray);
	/*if(isset($_GET['sl_no']) && isset($_GET['mcode']))
	  { 
				$objpick->DeleteIDEdit($_GET);	
       }
  ...
  $objSmarty->assign('IncludeTpl', 'pickDetails.tpl');
