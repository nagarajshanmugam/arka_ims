<?php
   require('includes/common.php');
	...
	if(isset($_POST['hdAction']))
		{
			$objStockInward->InsertLevels($_POST);
		}
	...
	if(isset($_GET['po_no']) || isset($_GET['invoice_no']))
		{
	$objStockInward->AjaxGetPoMaterialDetails($objArray);                  
		}
    ...
    {
        $objSmarty->assign('SuccessMessage1', 'Inward Updated Successfully');
    } 
  ...
  $objSmarty->assign('IncludeTpl', 'inward_location.tpl');
