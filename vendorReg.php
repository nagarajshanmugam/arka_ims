<?php
   require('includes/common.php');
    ...
    if(isset($_GET['server_response']))
         {
          $objSmarty->assign('SuccessMessage1', 'New Supplier Added Successfully');
	...
	//$objvendorReg->RolesLists();
	//$objvendorReg->GetvendorView($objArray);
...
/*if(isset($_POST['hdAction']))
  ...
  $objSmarty->assign('IncludeTpl', 'vendorReg.tpl');
