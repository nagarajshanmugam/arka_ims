<?php
 ...
 // include_once $config['SiteClassPath']."class.split_page_results.php"; 
	...
	$objEmployeeReg->ViewEdit($objArray);
	if(isset($_POST['hdAction']))
	{
	$objEmployeeReg->Editemployee($_POST,$_FILES);
	}  
	if(isset($_GET['succs_msg_for_insert']))
    {
    $objSmarty->assign('SuccessMessage1', 'Employee updated Successfully');
    }

  $objSmarty->assign('IncludeTpl', 'employee_edit.tpl');
