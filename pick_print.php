<?php
	...
	{  
		$objPick->Print_Pick_detail_L1($_GET);
		$objPick->Print_Pick_detail_L2($_GET);
		$objPick->Print_Pick_detail_L3($_GET);
		$objPick->Print_Pick_detail_No_Level($_GET);
		$objPick->Print_Pick_detail_E1($_GET);
		$objPick->Print_Pick_detail_E2($_GET);
		$objPick->Print_Pick_detail_H1($_GET);
		$objPick->Print_Pick_detail_H2($_GET);
		$objPick->Print_Pick_detail_GF($_GET);
	}
  
  $objSmarty->assign('IncludeTpl', 'pick_print.tpl');
