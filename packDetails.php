<?php
  require('includes/common.php');
	...
	if(isset($_GET['pack_id']))
	   {  
		$objpack->GetPackMasterDetails($_GET['pick_id']);		
       }
	$objpack->GetPackSlipMasterDetails($_GET);	
	$objpack->Print_Pack_detail($_GET);
	//$objpick->GetPickMasterDetails($objArray);
	$objpack->GetPackMasterList($objArray);
	if(isset($_GET['sl_no']))
	  { 
		$objpack->DeleteID($_GET['sl_no']);		
       }
  ...
  $objSmarty->assign('IncludeTpl', 'packDetails.tpl');
